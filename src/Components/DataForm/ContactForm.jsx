      ...
      <div className="mx-5">
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="">
            ...
            <button
              className="bg-blue-700 border text-white  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 "
            >
              Next
            </button>
          </div>
